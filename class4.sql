...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `class4` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `institute` VALUES ('01','IDL','baidu campus'),('02','cv lab','silicon valley');
...
INSERT INTO `involvement` VALUES (1,'01','01'),(2,'02','01'),(3,'01','02'),(4,'02','03');
...
INSERT INTO `project` VALUES ('01','liver segmentation',1000.00,'01'),('02','lung noudle segmentation',4321.98,'02');
...
INSERT INTO `researcher` VALUES ('01','hanlin','male',20,'rd','01'),('02','robin li','male',45,'instructor','01'),('03','haifeng wang','male',40,'instructor','02');
...
-- Dump completed on 2019-11-20  9:42:18
